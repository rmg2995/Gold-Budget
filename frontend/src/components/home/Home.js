...
const Home = () => {
  ...
  let [randomIncomeAmount, setRandomIncomeAmount] = useState(Math.floor(Math.random() * 10000))
  let [randomExpenseAmount, setRandomExpenseAmount] = useState(Math.floor(Math.random() * 10000))
